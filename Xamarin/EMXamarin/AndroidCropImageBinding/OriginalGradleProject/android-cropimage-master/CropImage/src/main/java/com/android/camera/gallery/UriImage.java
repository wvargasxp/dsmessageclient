...
class UriImage implements IImage {
    ...
    public Bitmap fullSizeBitmap(int minSideLength, int maxNumberOfPixels) {
        return fullSizeBitmap(minSideLength, maxNumberOfPixels,
                IImageConstants.ROTATE_AS_NEEDED, IImageConstants.NO_NATIVE);
    }

    public Bitmap fullSizeBitmap(int minSideLength, int maxNumberOfPixels,
            boolean rotateAsNeeded) {
        return fullSizeBitmap(minSideLength, maxNumberOfPixels,
                rotateAsNeeded, IImageConstants.NO_NATIVE);
    }
    ...
    public Bitmap miniThumbBitmap() {
        return thumbBitmap(IImageConstants.ROTATE_AS_NEEDED);
    }
    ...
    public Bitmap thumbBitmap(boolean rotateAsNeeded) {
        return fullSizeBitmap(IImageConstants.THUMBNAIL_TARGET_SIZE, IImageConstants.THUMBNAIL_MAX_NUM_PIXELS,
                rotateAsNeeded);
    }
