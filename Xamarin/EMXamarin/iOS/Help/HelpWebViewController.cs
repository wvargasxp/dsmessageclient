...
namespace iOS
{
	public class HelpWebViewController : UIViewController {
		...
		public HelpWebViewController(string title, string url) {
			this.title = title;
			this.url = url;
		}
		...
		public override void LoadView () {
			...
			webView = new UIWebView (new CGRect (0, 25, View.Frame.Width, View.Frame.Height - lineView.Frame.Height));
		...
		public override void ViewDidAppear (bool animated) {
			...
			GAI.SharedInstance.DefaultTracker.Set (GAIConstants.ScreenName, "Help Web View");
		...
		public override void ViewDidLayoutSubviews () {
			...
			webView.Frame = new CGRect (0, displacement_y + lineView.Frame.Height + UI_CONSTANTS.EXTRA_MARGIN, View.Frame.Width, View.Frame.Height - (displacement_y + lineView.Frame.Height + UI_CONSTANTS.EXTRA_MARGIN));
		}
