...
namespace iOS
{
	public sealed class GroupThumbnailView : BasicThumbnailView {

		UIButton backgroundImageView;
		public UIButton BackgroundImageView {
			...
			set {
				value.GetPhotoFrameLeftResource ((UIImage image) => {
					if (BackgroundImageView != null) {
						BackgroundImageView.SetBackgroundImage (image, UIControlState.Normal);
					}
				});
			}
		}

		public GroupThumbnailView () {
			BackgroundImageView = new UIButton (Bounds);
