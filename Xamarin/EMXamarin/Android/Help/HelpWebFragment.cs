...
namespace Emdroid
{
	public class HelpWebFragment: Fragment {
		...
		public static HelpWebFragment NewInstance (string title, string url) {
			var fragment = new HelpWebFragment ();
		...
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View v = inflater.Inflate(Resource.Layout.help_web, container, false);
		...
		public override void OnActivityCreated (Bundle savedInstanceState) {
			...
			AnalyticsHelper.SendView ("Help Web View");
		}
	}
}