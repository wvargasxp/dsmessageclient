...
namespace Emdroid {
	public class SuperEditText : EditText {
		const string Tag = "EditText";

		protected SuperEditText (IntPtr javaReference, JniHandleOwnership transfer)
		...
		public SuperEditText (Context context, IAttributeSet attrs, int defStyle)
